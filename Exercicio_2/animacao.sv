...
module vga(
  ...
  assign VGA_R = inDisplayArea ? {vdata[5], vdata[3], vdata[1], 2'b00} : 4'b0000;
  assign VGA_G = inDisplayArea ? {vdata[7], vdata[0], 2'b00} : 4'b0000;
  assign VGA_B = inDisplayArea ? {vdata[6], vdata[4], vdata[2], 2'b00} : 4'b0000;
endmodule
